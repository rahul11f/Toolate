...
async function main() {
  ...
  if (!user) {
    ...
    console.log('Updated existing regular user and set documentVerified:', user.email);
  }
  ...
  const mockProperties = [
    ...
    {
      title: 'Co-stay at Bangalore Grand Hyatt',
      description: 'Looking for a verified professional to split the cost of a Deluxe King Room at Grand Hyatt Bangalore. The booking is confirmed. I am traveling for a tech conference. Clean, respectful companion preferred.',
      category: 'HOTEL',
      price: 18000,
      openingHours: '09:00',
      closingHours: '21:00',
      landlordTerms: 'Split cost 50/50. Government ID verification required.',
      contactNumber: '9876543210',
      whatsappNumber: '9876543210',
      ...
      hotelName: 'Grand Hyatt Bengaluru',
      hotelBookingRef: 'REF-HYATT-9921',
      checkInDate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000),
      checkOutDate: new Date(Date.now() + 8 * 24 * 60 * 60 * 1000),
      hotelBookingProofUrl: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop&q=80',
      hotelSplitStatus: 'AVAILABLE',
      requireVerification: true,
      userId: user.id,
    },
    {
      title: 'Premium Stay Split at Taj Mahal Palace',
      description: 'Splitting an iconic sea-view room at Taj Mahal Palace, Mumbai. High-security, luxury amenities, and fine dining. Ideal for someone visiting Mumbai for business or leisure. Let\'s split 50/50.',
      category: 'HOTEL',
      price: 26000,
      openingHours: '08:00',
      closingHours: '22:00',
      landlordTerms: 'Strict background check. No visitors allowed inside. Respect quiet hours.',
      contactNumber: '9123456789',
      whatsappNumber: '9123456789',
    ...
    {
      title: 'Delhi Luxury Suite Share at The Leela',
      description: 'Shared room coordinate stay at The Leela Palace, New Delhi. I have booked a double occupancy executive suite. Looking to split the costs. Centrally located, fully verified.',
      category: 'HOTEL',
      price: 22000,
      openingHours: '10:00',
      closingHours: '20:00',
      landlordTerms: 'Verification required. Clean habits, split payment on check-in.',
      contactNumber: '8765432109',
      whatsappNumber: '8765432109',
      ...
      hotelBookingRef: 'REF-LEELA-5544',
      checkInDate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000),
      checkOutDate: new Date(Date.now() + 6 * 24 * 60 * 60 * 1000),
      hotelBookingProofUrl: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop&q=80',
      hotelSplitStatus: 'AVAILABLE',
      requireVerification: true,
      userId: user.id,
